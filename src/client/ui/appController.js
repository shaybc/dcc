...
const paginationController = createPaginationController({
  paginationContainer,
  getCurrentCardsPage: () => currentCardsPage,
  setCurrentCardsPage: (value) => { currentCardsPage = value; },
  renderCards: () => renderCards(),
});

const { renderPagination } = paginationController;

let activityUtils = null;
let findDefinitionByPath = null;
let getRunNameFromPath = null;
let setActivityDefinitionLink = null;
let openDefinitionDetailsByPath = null;
...
export function initializeApp() {
  activityUtils = createActivityUtils({
    getDefinitions: () => definitions,
    showHubPage,
    updateRouteForHub,
    showDetails,
  });
  ({ findDefinitionByPath, getRunNameFromPath, setActivityDefinitionLink, openDefinitionDetailsByPath } = activityUtils);
