...
export function createWorkflowForm({ mount, onChange, availableTags = [] }) {
  ...
  const description = createTextInput({ mount, label: "description", state, key: "description", multiline: true, placeholder: "e.g., 'the description of this workflow'", onChange });
