...
export function createDocForm({ mount, onChange, availableTags = [] }) {
  ...
  const description = createTextInput({ mount, label: "description", state, key: "description", multiline: true, placeholder: "e.g., 'Documentation links for Continue'", onChange });
