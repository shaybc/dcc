...
test("raw connector mode sends Gemini payload with tools to /raw endpoint", async () => {
  ...
  try {
    ...
    assert.equal(capturedUrl, "https://connector.example.com/api/connectors/abc/raw");
